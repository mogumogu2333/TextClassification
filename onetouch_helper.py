...
def load_data_and_labels():
    ...
    # Generate labels
    music_labels = [[1, 0, 0] for _ in music_examples]
    call_labels = [[0, 1, 0] for _ in call_examples]
    command_labels = [[0, 0, 1] for _ in command_examples]
    y = np.concatenate([music_labels, call_labels, command_labels], 0)
    return [x_text, y]
